...
// 1) 명령 프롬프트를 출력한다(main())
// 2) 명령어를 입력 받아 출력한다(scanner)
// 3) 명령어를 입력 받는 것을 반복한다(while)
// 4) /member/add 와 /member/list 명령을 구분한다(switch)
// 5) /project/add 와 /project/list 명령을 처리한다
