...
public class Exam0450 {
  public static void main(String[] args) {
    ...
    lang2 |= 0x80; // = lang = lang2 | 0x80  c = true 
...
// 비트 연산자를 이용하여 비트로 저장할 수 있다.
// 운영체제 일부도 이런식으로 저장되어 있다.
// 터미널에 파일 접근 표시도 3비트씩 3개로 이루어져 있다.
// 비트 연사자를 사용하여 프로그램을 설계하면 메모리를 훨씬 절약할 수 있다.
