...
public class Exam0351 {
  public static void main(String[] args) {
    ...
    // % 연산은 나누기 연산을 수행해야 한다.
    // 나누기 연산은 여러번의 계산을 수행해야 한다.
    // 그에 비해 & 비트 연산자는 한 번만 하면 된다.
    // 어떤 값에 대해 2로 나눈 나머지 값을 구하고 싶다면,
    // & 연산자를 이용하여 그 값의 하위 1비트 값만 추출하면 된다.
    
    // 즉 1) 짝수인지 홀수인지 알아내야 하거나
    //    2)  2의 나머지를 구해야 한다면
    // & 비트 연산자를 사용하는 것이 빠르다. 
    ...
    // 나누는 값이 2제곱수여야 한다.
    // - 2의 보수로 나머지 값을 구하는 경우에는
    // % 대신 & 연산자를 사용하면 계산 속도가 빠르다.
    // 그냥 % 쓰자.. 다른 개발자가 이해하기 편할 것이다.
    // 그럼에도 불구하고 이 연산자의 활용법을 익히는 이유는 
    // 가끔 오픈 소스 코드에서 이런 코드를 만나기 때문이다.
