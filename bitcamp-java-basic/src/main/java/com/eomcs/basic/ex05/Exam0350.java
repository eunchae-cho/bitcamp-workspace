...
//          빛이 없는 점은 빛을 넣는다. ( 0 --> 1)
//=> 다음과 같이 흑색의 한 점이 있다.
//   00000000 00000000 00000000 (변경전 색 - 검은색)
// ~  
//-------------------------------
...
// -------------------------------
//   00000000 00000000 00000000 (변견된 색)
// => 한 점에 대해 연산한 출력 결과가 0이면 해당 점의 색상을 제거하고
//      만약 0이 아니면 원래 색상을 그대로 사용한다.

// 1920 * 1080 = 2073600 픽셀
// 1 픽셀 
// => 3byte : red(8bit) + blue(8bit) + green(8bit)
//          = 3byte/pixel
//          = 16777216 색상
// 2073600 pixel * 3byte = 6228900 byte = 6082 KB = 5.94 MB
// 1000_0000 * 3 = 3000_0000 = 29_296 KB = 28.6 MB (raw data file) 
//

// 80분 영화
// 80(분) * 60(초) * 24(장/초)
// = 115200(장) => 손실압축 JPG / 무손실압축 GIF
// 용량
// == 115200 * 6MB = 691200MB = 675GB  => 4GB로 손실 압축(MPEG)