...
//    elementData = newArray;
  ...
  public Object remove(int index) {
    ...
    size--;
    elementData[size] = null; // 쓰지 않는 인스턴스 제거 - garbage로 만듦
    return old;
  }
