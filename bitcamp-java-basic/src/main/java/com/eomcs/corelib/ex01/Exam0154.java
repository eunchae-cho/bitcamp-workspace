...
public class Exam0154 {
  public static void main(String[] args) {
    ...
    // => key 값으로 int를 넘겨준다면,
    //    컴파일러가 컴파일할 때 내부적으로 auto-boxing을 수행하여 Integer 객체를 만든다.
    //    그리고 그 객체를 넘겨주는 것이다.
    map.put(104,/*new Integer*/ new Student("안중근", 24, true));
    map.put(105,/*new Integer*/ new Student("윤봉길", 22, false));
    // HashMap 객체를 만들때 key 타입으로 Integer를 사용하기로
